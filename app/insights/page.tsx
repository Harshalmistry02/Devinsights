...
export default async function InsightsPage() {
  ...
  // Check if user has data (temporarily allowing 0 commits for testing)
  const hasData = analytics !== null; // TODO: Change back to `analytics !== null && analytics.totalCommits > 0` for production
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {hasData ? (
          <div className="space-y-6">
            ...
            {/* Analytics Visualizations - Temporarily disabled for testing */}
